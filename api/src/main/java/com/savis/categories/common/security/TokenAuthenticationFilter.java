...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
	...
	public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
		...
		if (authToken != null) {
			...
			if (username != null && !username.equals("TOKEN_EXPIRED")) {
			...
			} else if (username.equals("TOKEN_EXPIRED")) {
				error = "Token expired";
			}else{
		...
		if (!error.equals("")) {
			...
			SecurityContextHolder.getContext().setAuthentication(new AnonAuthentication());// prevent
		}
